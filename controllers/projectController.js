...
const getProjects = async (req, res) => {
  try {
    ...
    const cacheKey = `projects_${page}_${limit}_${sort}_${sortBy}`;
    ...
    if (cachedData) {
      return successResponse(
        ...
        200,
        cachedData,
        "Projects retrieved successfully (from cache)"
      );
    }
    ...
    cache.set(cacheKey, { allProjects, page, totalPages, totalProjects }, 3600);
    return successResponse(
      res,
      200,
      {
